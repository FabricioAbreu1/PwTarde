    ...
    <div class="row">
        ...
        <div class="card mt-3">
            ...
            <form action ="./disciplinas.php" mehod="get">
            <div class="row">
            <div class="col-3">
            ...
            <div class="col-2"><button type="submit" class = "btn btn-primary">
            ...
            <table class = "table table-hover table-striped">
                ...
                ?>
                    ...
                    <td>
                        <a href="./editar_disciplinas.php?id=<?php echo $dados[$i]["disciplinaId"];?>" class="btn btn-warning">
                        Editar
                    </a>
                    </td>
    </tr>
